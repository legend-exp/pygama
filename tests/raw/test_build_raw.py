...
def test_build_raw_fc(lgnd_test_data):
    ...
    build_raw(in_stream=lgnd_test_data.get_path('fcio/L200-comm-20211130-phy-spms.fcio'),
              out_spec=out_file, overwrite=True)
...
def test_build_raw_fc_out_spec(lgnd_test_data):
    ...
    build_raw(in_stream=lgnd_test_data.get_path('fcio/L200-comm-20211130-phy-spms.fcio'),
              out_spec=out_spec, n_max=10, overwrite=True)
    ...
    build_raw(in_stream=lgnd_test_data.get_path('fcio/L200-comm-20211130-phy-spms.fcio'),
              out_spec=f'{config_dir}/fc-out-spec.json', n_max=10, overwrite=True)
...
def test_build_raw_orca(lgnd_test_data):
    build_raw(in_stream=lgnd_test_data.get_path('orca/fc/L200-comm-20220519-phy-geds.orca'),
              overwrite=True)
...
def test_build_raw_orca_out_spec(lgnd_test_data):
    ...
    build_raw(in_stream=lgnd_test_data.get_path('orca/fc/L200-comm-20220519-phy-geds.orca'),
              out_spec=f'{config_dir}/orca-out-spec.json', n_max=10, overwrite=True)
