...
def test_representations():
    objs = {
        ...
        "ArrayOfEqualSizedArrays": lgdo.ArrayOfEqualSizedArrays(nda=np.random.rand(10, 100), attrs={"unit": "ns"}),
        "Struct": lgdo.Struct({
            ...
            "fourth": lgdo.ArrayOfEqualSizedArrays(nda=np.random.rand(10, 100), attrs={"unit": "ns"}),
        }, attrs={"unit": "ns"}),
