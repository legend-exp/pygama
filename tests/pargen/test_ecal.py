...
def test_hpge_cal(lgnd_test_data):
    ...
    # load test data here
    data = lgnd_test_data.get_path("lh5/prod-ref-l200/generated/tier/dsp/cal/p03/r000/l200-p03-r000-cal-20230311T235840Z-tier_dsp.lh5")
    ...
    assert out_dict == {"expression": "a + b * cuspEmax", "parameters": {"a": 0.0, "b":2615/np.nanpercentile(energy, 99)}}
    ...
    assert approx(cal.results["hpge_fit_energy_peaks"]["FWHMLinear"]["Qbb_fwhm_in_kev"],0.1)==2.3
