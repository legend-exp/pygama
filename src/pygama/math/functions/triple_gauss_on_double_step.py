...
(x_lo, x_hi, area1, mu1, sigma1, area4, hstep1, area2, mu2, sigma2, area5, hstep2) = range(12)
par_array = [(gauss_on_step, [x_lo, x_hi, area1, mu1, sigma1, area4, hstep1]), (gauss_on_step, [x_lo, x_hi, area2, mu2, sigma2, area5, hstep2])] 

double_gauss_on_double_step = sum_dists(par_array, [], None, parameter_names = ["x_lo", "x_hi", "area1", "mu1", "sigma1", "area4", "hstep1", "area2", "mu2", "sigma2", "area5", "hstep2"])
