...
class DataDecoder(ABC):
    ...
    """
    def __init__(self, garbage_length: int = 256, packet_size_guess: int = 1024) -> None:
    ...
    def write_out_garbage(self, filename: str, group: str = '/', lh5_store: LH5Store = None) -> None:
