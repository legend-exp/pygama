...
class DataSet:
    ...
    def get_paths(self, runs, subfile, verbose=False):
        ...
        Other structure are not implemented. If no filetype flag is given, the original file search is done.
...
>>>>>>> ca923af50664d8ae716bc499562ca9584f97b791
        """
